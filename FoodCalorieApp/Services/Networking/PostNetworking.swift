...
//MARK:-Static function
    ...
    guard let url = URL(string: "https://api.edamam.com/api/food-database/parser?nutrition-type=logging&ingr=\(input)&app_id=c3f9917c&app_key=28f470c4c0d9c3dc18b95631a5ba82b0") else {
        return
        }
    print(url)
